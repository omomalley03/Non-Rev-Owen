...
--------
    ...
    python decoders/predict_mcmaze_velocity.py
    python decoders/predict_mcmaze_velocity.py --run 2 --horizon-ms 100
    python decoders/predict_mcmaze_velocity.py --run mcmaze/runs/my_run --mlp-epochs 100
"""
