...
--------
    ...
    python decoders/predict_physionet_condition_finetune.py --run 2 --feature-layer hidden
    python decoders/predict_physionet_condition_finetune.py --run 2 --embedder-init random --feature-layer hidden
    python decoders/predict_physionet_condition_finetune.py --run 2 --decoder-type mlp
"""
