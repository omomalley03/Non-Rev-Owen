...
--------
    ...
    python decoders/predict_physionet_condition.py
    python decoders/predict_physionet_condition.py --run 2 --mlp-epochs 100
    python decoders/predict_physionet_condition.py --decoder-split random
    python decoders/predict_physionet_condition.py --run 2 --feature-layer hidden
    python decoders/predict_physionet_condition.py --run 2 --embedder-init random --feature-layer hidden
"""
