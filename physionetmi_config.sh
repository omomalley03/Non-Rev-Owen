...
export SYNTH_NORMALIZE="train_zscore"  # zscore or train_zscore
...
export SYNTH_HOLDOUT_SUBJECT_COUNT="0"  # 0 means no held-out test participants for old figure plots
export SYNTH_HOLDOUT_SUBJECT_IDS=""
export SYNTH_VIZ_MAX_TRIALS="2000"
...
export SYNTH_VIZ_PARTICIPANT_IDS="59,44,108,79"  # optional explicit IDs for participant-condition plots
export SYNTH_VIZ_PLANE_INDICES="30,19,47,39"     # optional explicit planes for participant-condition plots
export VAL_SPLIT="0.1" # subject_random trial fraction; subject_holdout fallback subject fraction when val count/IDs are unset
