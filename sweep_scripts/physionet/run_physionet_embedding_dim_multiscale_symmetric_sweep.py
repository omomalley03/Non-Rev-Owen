...
Usage:
    micromamba run -n nonrev python -u sweep_scripts/physionet/run_physionet_embedding_dim_multiscale_symmetric_sweep.py
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=REPO_ROOT / "configs" / "physionetmi_config.sh",
