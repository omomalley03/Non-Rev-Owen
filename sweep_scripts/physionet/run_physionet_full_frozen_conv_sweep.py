...
Usage:
    micromamba run -n nonrev python -u sweep_scripts/physionet/run_physionet_full_frozen_conv_sweep.py --max-attempts 20
"""
...
def run_one(attempt: int, candidate_json: str) -> dict[str, Any]:
    ...
    from decoders.predict_physionet_condition import (
