...
Examples
--------
    python plotting/mcmaze/plot_mcmaze_plane_spectral_redundancy.py --run mcmaze/runs/...
    python plotting/mcmaze/plot_mcmaze_plane_spectral_redundancy.py --run physionetmi/synth_runs/...
    python plotting/mcmaze/plot_mcmaze_plane_spectral_redundancy.py --checkpoint mcmaze/runs/.../checkpoints/best.pt
    python plotting/mcmaze/plot_mcmaze_plane_spectral_redundancy.py --finetuned-model mcmaze/runs/.../outputs/.../finetuned_model.pt
"""
