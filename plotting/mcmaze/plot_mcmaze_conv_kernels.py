...
--------
    ...
    python plotting/mcmaze/plot_mcmaze_conv_kernels.py
    python plotting/mcmaze/plot_mcmaze_conv_kernels.py --run 2
    python plotting/mcmaze/plot_mcmaze_conv_kernels.py --run mcmaze/runs/20260706_141117_...
    python plotting/mcmaze/plot_mcmaze_conv_kernels.py --checkpoint mcmaze/runs/.../checkpoints/best.pt
    python plotting/mcmaze/plot_mcmaze_conv_kernels.py --kernel-mode raw
    python plotting/mcmaze/plot_mcmaze_conv_kernels.py --kernel-mode symmetric
    python plotting/mcmaze/plot_mcmaze_conv_kernels.py --kernel-mode antisymmetric
    python plotting/mcmaze/plot_mcmaze_conv_kernels.py --all
"""
