...
--------
    ...
    python plotting/embedding/plot_nonrev_components.py
    python plotting/embedding/plot_nonrev_components.py --run mcmaze/runs/20260710_064929_...
    python plotting/embedding/plot_nonrev_components.py --run 2 --out /tmp/nonrev_components.png
"""
