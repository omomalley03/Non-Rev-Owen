...
Examples
--------
    python plotting/embedding/plot_embedding_plane_timeseries_fft.py --run mcmaze/runs/...
    python plotting/embedding/plot_embedding_plane_timeseries_fft.py --run physionetmi/synth_runs/... --participants 59,44,108,79 --planes 30,19,47,39
    python plotting/embedding/plot_embedding_plane_timeseries_fft.py --checkpoint mcmaze/runs/.../checkpoints/best.pt
    python plotting/embedding/plot_embedding_plane_timeseries_fft.py --run 1 --trial-index 0
"""
